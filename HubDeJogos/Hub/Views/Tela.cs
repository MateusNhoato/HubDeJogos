...
|_______||_|  |__|  |___|  |___|  |_||__| |__||___|  |_|";
        ...
        private readonly static string _listaDeJogadores = @"
 ___      ___   _______  _______  _______    ______   _______        ___  _______  _______  _______  ______   _______  ______    _______  _______ 
|   |    |   | |       ||       ||   _   |  |      | |       |      |   ||       ||       ||   _   ||      | |       ||    _ |  |       ||       |
|   |    |   | |  _____||_     _||  |_|  |  |  _    ||    ___|      |   ||   _   ||    ___||  |_|  ||  _    ||   _   ||   | ||  |    ___||  _____|
|   |    |   | | |_____   |   |  |       |  | | |   ||   |___       |   ||  | |  ||   | __ |       || | |   ||  | |  ||   |_||_ |   |___ | |_____ 
|   |___ |   | |_____  |  |   |  |       |  | |_|   ||    ___|   ___|   ||  |_|  ||   ||  ||       || |_|   ||  |_|  ||    __  ||    ___||_____  |
|       ||   |  _____| |  |   |  |   _   |  |       ||   |___   |       ||       ||   |_| ||   _   ||       ||       ||   |  | ||   |___  _____| |
|_______||___| |_______|  |___|  |__| |__|  |______| |_______|  |_______||_______||_______||__| |__||______| |_______||___|  |_||_______||_______|";
...
|__| |__||___| |_______|  |___|  |_______||___|  |_||___| |_______||_______|";
        ...
        {
            Console.Clear();
            Console.WriteLine(_listaDeJogadores + "\n");
