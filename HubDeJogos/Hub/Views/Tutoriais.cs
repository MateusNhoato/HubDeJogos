namespace HubDeJogos.Hub.Views
{
  ...
  _____________|____________|_______________
   ...
   |   _   |   |  |  |_|  | |       |   |
   |__| |__|   |  |_______| |       |___|";
        private readonly static string _algumTempoDepois = @"
   _______  ___      _______  __   __  __   __       
  |   _   ||   |    |       ||  | |  ||  |_|  |      
  |  |_|  ||   |    |    ___||  | |  ||       |      
  |       ||   |    |   | __ |  |_|  ||       |      
  |       ||   |___ |   ||  ||       ||       |      
  |   _   ||       ||   |_| ||       || ||_|| |      
  |__| |__||_______||_______||_______||_|   |_|      
  ...
  |       ||    ___||  _    ||      _||    ___|| |_|   ||  |_|  ||    __  |  |   |    |     | 
   |     | |   |___ | | |   ||     |_ |   |___ |       ||       ||   |  | |  |___|   |   _   |
    |___|  |_______||_|  |__||_______||_______||______| |_______||___|  |_|          |__| |__|";
        public readonly static string[] JogoDaVelhaAnimação = new string[6]
